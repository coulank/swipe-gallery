...
if (!is_admin()) {
	...
	function register_script(){  // 登録の項目
		...
		wp_register_script('slide-gallery', get_stylesheet_directory_uri() . '/js/slide-gallery.js', array( 'jq-hammer' ), '1.3.2', true);
	}
	...
	function add_style(){
		wp_enqueue_style('slide-gallery', get_stylesheet_directory_uri() . '/css/slide-gallery.css', array(), '1.3.2');
	}
